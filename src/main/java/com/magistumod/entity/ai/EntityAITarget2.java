...
public abstract class EntityAITarget2 extends EntityAIBase
{
    ...
    public EntityAITarget2(EntityCreature creature, boolean checkSight)
    {
        this(creature, checkSight, false);
    }

    public EntityAITarget2(EntityCreature creature, boolean checkSight, boolean onlyNearby)
    {
        this.unseenMemoryTicks = 60;
        this.taskOwner = creature;
        if (taskOwner.isRiding() && taskOwner.getRidingEntity() instanceof EntitySeat)
    ...
    public boolean shouldContinueExecuting()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if (this.shouldCheckSight || (this.taskOwner.isRiding() && this.taskOwner.getRidingEntity() instanceof EntitySeat))
                    {
    ...
    {
        if (!isSuitableTarget(this.taskOwner, target, includeInvincibles, this.shouldCheckSight || (this.taskOwner.isRiding() && this.taskOwner.getRidingEntity() instanceof EntitySeat)))
        {
            return false;
        }
