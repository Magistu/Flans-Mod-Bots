...
public class GuiNpcTextArea extends GuiNpcTextField
{
    ...
    private void drawCursorVertical(int startX, int startY, int endX, int endY) {
        ...
        tessellator.pos((double)startX, (double)endY, 0.0).endVertex();
        tessellator.pos((double)endX, (double)endY, 0.0).endVertex();
        tessellator.pos((double)endX, (double)startY, 0.0).endVertex();
        tessellator.pos((double)startX, (double)startY, 0.0).endVertex();
