...
public class GuiNpcMobSpawnerAdd extends GuiNPCInterface implements GuiYesNoCallback, IGuiData
{
    ...
    public GuiNpcMobSpawnerAdd(NBTTagCompound compound) {
        this.toClone = EntityList.createEntityFromNBT(compound, (World)Minecraft.getMinecraft().world);
    ...
    public void initGui() {
        ...
        this.addButton(new GuiNpcButton(3, this.guiLeft + 4, this.guiTop + 95, new String[] { "clone.client", "clone.server" }, (int)(GuiNpcMobSpawnerAdd.serverSide ? 1 : 0)));
        ...
        if (id == 0) {
            ...
            if (!GuiNpcMobSpawnerAdd.serverSide) {
                if (ClientCloneController.Instance.getCloneData(null, name, tab) != null) {
                    this.displayGuiScreen((GuiScreen)new GuiYesNo((GuiYesNoCallback)this, "", I18n.translateToLocal("clone.overwrite"), 1));
                }
                else {
