...
public class GuiNpcPuppet extends GuiNPCInterface implements ISliderListener, ICustomScrollListener
{
    ...
    public void initGui() {
        ...
        y += 22;
        this.addButton(new GuiNpcButton(i2, j3, y, 60, 20, new String[] { "gui.yes", "gui.no" }, (int)(this.job.animate ? 0 : 1)));
    ...
    private void drawSlider(int y, JobPuppet.PartConfig config) {
        this.addButton(new GuiNpcButton(29, this.guiLeft + 140, y, 80, 20, new String[] { "gui.enabled", "gui.disabled" }, (int)(config.disabled ? 1 : 0)));
        y += 22;
