...
public class LayerHead extends LayerInterface
{
    ...
    private void createParts() {
        (this.small = new ModelRenderer((ModelBase)this.model, 24, 0)).addBox(0.0f, 0.0f, 0.0f, 4, 3, 1);
        this.small.setRotationPoint(-2.0f, -3.0f, -5.0f);
        (this.medium = new ModelRenderer((ModelBase)this.model, 24, 0)).addBox(0.0f, 0.0f, 0.0f, 4, 3, 2);
        this.medium.setRotationPoint(-2.0f, -3.0f, -6.0f);
        (this.large = new ModelRenderer((ModelBase)this.model, 24, 0)).addBox(0.0f, 0.0f, 0.0f, 4, 3, 3);
        this.large.setRotationPoint(-2.0f, -3.0f, -7.0f);
        (this.bunnySnout = new ModelRenderer((ModelBase)this.model, 24, 0)).addBox(1.0f, 1.0f, 0.0f, 4, 2, 1);
        ...
        (this.beard = new Model2DRenderer((ModelBase)this.model, 56.0f, 20.0f, 8, 12)).setRotationOffset(-3.99f, 11.8f, -4.0f);
        this.beard.setScale(0.74f);
        (this.hair = new Model2DRenderer((ModelBase)this.model, 56.0f, 20.0f, 8, 12)).setRotationOffset(-3.99f, 11.8f, 3.0f);
        this.hair.setScale(0.75f);
        (this.mohawk = new Model2DRenderer((ModelBase)this.model, 0.0f, 0.0f, 64, 64)).setRotationOffset(-9.0f, 0.1f, -0.5f);
