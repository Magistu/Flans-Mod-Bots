...
public class LayerBody extends LayerInterface
{
    ...
    private void createParts() {
        ...
        (this.rWing = new Model2DRenderer((ModelBase)this.model, 56.0f, 16.0f, 8, 16)).setRotationPoint(-2.0f, 2.5f, 1.0f);
        this.rWing.setRotationOffset(-8.0f, 14.0f, 0.0f);
        this.setRotation(this.rWing, 0.7141593f, 0.5235988f, 0.5090659f);
        (this.breasts = new Model2DRenderer((ModelBase)this.model, 20.0f, 22.0f, 8, 3)).setRotationPoint(-3.6f, 5.2f, -3.0f);
        ...
        (this.fin = new Model2DRenderer((ModelBase)this.model, 56.0f, 20.0f, 8, 12)).setRotationPoint(-0.5f, 12.0f, 10.0f);
