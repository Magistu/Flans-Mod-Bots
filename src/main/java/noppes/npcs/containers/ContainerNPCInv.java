...
public class ContainerNPCInv extends Container
{
    public ContainerNPCInv(EntityNPCInterface npc, EntityPlayer player) {
        this.addSlotToContainer((Slot)new SlotNPCArmor((IInventory)npc.inventory, 0, 9, 22, EntityEquipmentSlot.HEAD));
        this.addSlotToContainer((Slot)new SlotNPCArmor((IInventory)npc.inventory, 1, 9, 40, EntityEquipmentSlot.CHEST));
        this.addSlotToContainer((Slot)new SlotNPCArmor((IInventory)npc.inventory, 2, 9, 58, EntityEquipmentSlot.LEGS));
        this.addSlotToContainer((Slot)new SlotNPCArmor((IInventory)npc.inventory, 3, 9, 76, EntityEquipmentSlot.FEET));
