...
public class ContainerNPCCompanion extends ContainerNpcInterface
{
    ...
    public ContainerNPCCompanion(EntityNPCInterface npc, EntityPlayer player) {
        ...
        if (this.role.getTalentLevel(EnumCompanionTalent.ARMOR) > 0) {
            this.addSlotToContainer((Slot)new SlotCompanionArmor(this.role, (IInventory)npc.inventory, 0, 6, 8, EntityEquipmentSlot.HEAD));
            this.addSlotToContainer((Slot)new SlotCompanionArmor(this.role, (IInventory)npc.inventory, 1, 6, 26, EntityEquipmentSlot.CHEST));
            this.addSlotToContainer((Slot)new SlotCompanionArmor(this.role, (IInventory)npc.inventory, 2, 6, 44, EntityEquipmentSlot.LEGS));
            this.addSlotToContainer((Slot)new SlotCompanionArmor(this.role, (IInventory)npc.inventory, 3, 6, 62, EntityEquipmentSlot.FEET));
        }
