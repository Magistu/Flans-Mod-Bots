...
public class EntityAIPounceTarget extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        return this.leapTarget != null && this.npc.getEntitySenses().canSee((Entity)this.leapTarget) && !this.npc.isInRange((Entity)this.leapTarget, 4.0) && this.npc.isInRange((Entity)this.leapTarget, 8.0) && this.npc.getRNG().nextInt(5) == 0;
    }
