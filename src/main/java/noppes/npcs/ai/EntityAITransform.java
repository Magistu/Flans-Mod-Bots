...
public class EntityAITransform extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        return !this.npc.isKilled() && !this.npc.isAttacking() && !this.npc.transform.editingModus && ((this.npc.world.getWorldTime() % 24000L < 12000L) ? this.npc.transform.isActive : (!this.npc.transform.isActive));
    }
