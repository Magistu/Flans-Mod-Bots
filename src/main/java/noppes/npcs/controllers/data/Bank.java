...
public class Bank
{
    ...
    public boolean canBeUpgraded(int slot) {
        return this.upgradeInventory.getStackInSlot(slot) != null && !this.upgradeInventory.getStackInSlot(slot).isEmpty() && (this.slotTypes.get(slot) == null || this.slotTypes.get(slot) == 0);
    }
